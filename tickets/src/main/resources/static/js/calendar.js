    ...
    Calendar.prototype = {
        ...
        getDayAction: function(day) {
            ...
            if (this.selectedRang) {
                let start = Date.tryParse(this.selectedRang[0]),
        ...
        getDayItem: function(y, m, d, f) {
            ...
            let selected = dt.isSame(y, m, d) ? SELECT_CLASS : '';
            if (f === 1) {
        ...
        getDaysHtml: function(y, m) {
            let year, month, firstWeek, daysNum, prevM, prevDiff,
                dt = this.date,
            ...
            for (let n = 1, nl = 42 - count; n <= nl; n++) {
        ...
        fillDateItems: function(y, m) {
            ...
            this.$dateItems.html('');
            for (let i = 0; i < 3; i++) {
                let $item = this.getDaysHtml(ma[i].y, ma[i].m);
        ...
        getDisDateValue: function() {
            let arr = this.$disDate.html().split('/'),
                y = Number(arr[0]),
        ...
        selectedDay: function(d, type) {
            ...
            if (type) {
                let ret = this.updateDateView(y, m, {
                    'old': 'prev',
                    'new': 'next'
                }[type], toggleClass);
                y = ret.y;
        ...
        event: function() {
            ...
            _this.$element.on('click', ARROW_DATE, function() {
                ...
                let d = _this.updateDateView(y, m, type, function() {
                    vc('date', d.y, d.m);
                });

            }).on('click', ARROW_MONTH, function() {

                let y = Number(_this.$disMonth.html()),
                    type = getClass(this);
            ...
            _this.$element.on('click', '[' + ITEM_DAY + ']', function() {
                let d = parseInt(this.innerHTML),
                    cls = getClass(this),
                    type = /new|old/.test(cls) ? cls.match(/new|old/)[0] : '';

                let day = _this.selectedDay(d, type);
